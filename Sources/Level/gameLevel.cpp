...
void DrawWizard(int x, int y, int visionTower){
    ...
    if (visionTower == 1) {
        DrawTexturePro(GameTextures::whizardForTower, { 352, 207, CELL_SIZE, CELL_SIZE }, 
            cell, {0.0f, 0.0f}, 0.0f, WHITE);
    }

    if (visionTower == 2) {
        DrawTexturePro(GameTextures::whizardForTower, { 352, 161, CELL_SIZE, CELL_SIZE }, 
            cell, {0.0f, 0.0f}, 0.0f, WHITE);
    }
    ...
    if (visionTower == 4) {
        DrawTexturePro(GameTextures::whizardForTower, { 352, 176, CELL_SIZE, CELL_SIZE }, 
            cell, {0.0f, 0.0f}, 0.0f, WHITE);
    }
